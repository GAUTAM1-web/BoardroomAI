...
from app.domain.boardroom.intelligence import (
    build_ai_reflection,
    build_boardroom_timeline,
    build_cognitive_bias_detection,
    build_confidence_propagation,
    ...
    build_dynamic_expert_roster,
    build_evidence_packet,
    build_executive_challenge_questions,
    build_executive_performance_tracking,
...
def build_report(
    ...
    sections = {
        ...
        "internal_research": build_internal_research(
            brief,
            assessment,
            invited_executives=invited_executives,
        ),
        "reasoning_pipeline": build_reasoning_pipeline(
            brief,
            assessment,
            turns,
            votes,
        ...
        "counterfactual_analysis": build_counterfactual_analysis(brief, assessment, decision),
        "scenario_simulator": build_scenario_simulator(brief, assessment, decision),
        "cognitive_bias_detection": build_cognitive_bias_detection(
            brief,
            assessment,
            turns,
            decision,
        ),
        "executive_challenge_questions": build_executive_challenge_questions(brief, assessment),
        "dynamic_expert_roster": build_dynamic_expert_roster(invited_executives),
        "startup_overview": _startup_overview(brief, decision, aggregate_confidence),
        ...
        "confidence_propagation": build_confidence_propagation(turns, votes),
        "vote_timeline": build_vote_timeline(votes),
        "reasoning_flow": build_reasoning_flow(brief, assessment, turns, decision),
        "debate_tree": build_debate_tree(turns),
        "boardroom_timeline": build_boardroom_timeline(turns, votes),
        "meeting_replay": build_meeting_replay(turns, votes),
        "executive_scorecard": build_executive_scorecard(turns, votes),
        "executive_performance_tracking": build_executive_performance_tracking(turns, votes),
        ...
        "validation_plan": build_validation_plan(assessment),
        "ai_reflection": build_ai_reflection(brief, assessment, turns),
